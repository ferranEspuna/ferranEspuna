...
- Development and automation of [CURATE](https://github.com/langtech-bsc/CURATE), a large-scale corpus processing pipeline for HPC environments
- Contribution to [CATalog](https://huggingface.co/datasets/projecte-aina/CATalog), a large Catalan pretraining corpus
